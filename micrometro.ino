#define   SDA 9           // data pin from caliper
#define   SCK 8           // clock pin from caliper
...
void loop() {
  ...
  while(1) {
    ...
    if (digitalRead(SCK) == LOW) {
      ...
      //Serial.print("SCK high: "); Serial.print(gv_ixClock);  Serial.print("\t"); Serial.print(TCNT1);  Serial.print("\t"); Serial.print(TIFR1);  Serial.print("\t"); Serial.print(gv_mode);  Serial.print("\t"); Serial.println(gv_ctReset);
